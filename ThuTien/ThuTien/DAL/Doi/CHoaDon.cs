...
namespace ThuTien.DAL.Doi
{
    class CHoaDon : CDAL
    {
        ...
        /// <returns></returns>
        public bool ThemChia_SoPhatHanh(string Loai, int MaTo, int DotChia, decimal TuSoPhatHanh, decimal DenSoPhatHanh, int Nam, int Ky, int Dot, int MaNV)
        {
            try
            {
                if (Loai == "TG")
        ...
        public bool ThemChia_MLT(string Loai, int MaTo, int DotChia, decimal TuMLT, decimal DenMLT, int Nam, int Ky, int Dot, int MaNV)
        {
            try
            {
                if (Loai == "TG")
                {
                    ...
                    //                    .ForEach(item => { item.MaNV_HanhThu = MaNV; item.ModifyBy = CNguoiDung.MaND; item.ModifyDate = DateTime.Now; });
                    string sql = "update HOADON set MaNV_HanhThu=" + MaNV + ",DOTCHIA=" + DotChia + ",NGAYGIAO='" + DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss.fff", CultureInfo.InvariantCulture) + "',ModifyBy=" + CNguoiDung.MaND + ",ModifyDate=getdate() "
                                + "where MALOTRINH>=" + TuMLT + " and MALOTRINH<=" + DenMLT + " and NAM=" + Nam + " and KY=" + Ky + " and DOT=" + Dot + " and GB>=10 and GB<=20 "
                                + "and MAY>=" + ExecuteQuery_DataTable("select TuCuonGCS from TT_To where MaTo=" + MaTo).Rows[0][0] + " and MAY<=" + ExecuteQuery_DataTable("select DenCuonGCS from TT_To where MaTo=" + MaTo).Rows[0][0] + "";
                    LinQ_ExecuteNonQuery(sql);
                }
                else
                    if (Loai == "CQ")
                    {
                        ...
                        {
                            string sql = "update HOADON set MaNV_HanhThu=" + MaNV + ",DOTCHIA=" + DotChia + ",NGAYGIAO='" + DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss.fff", CultureInfo.InvariantCulture) + "',ModifyBy=" + CNguoiDung.MaND + ",ModifyDate=getdate() "
                                        + "where MALOTRINH>=" + TuMLT + " and MALOTRINH<=" + DenMLT + " and NAM=" + Nam + " and KY=" + Ky + " and DOT=" + Dot
                                        + " and MAY>=" + ExecuteQuery_DataTable("select TuCuonGCS from TT_To where MaTo=" + MaTo).Rows[0][0] + " and MAY<=" + ExecuteQuery_DataTable("select DenCuonGCS from TT_To where MaTo=" + MaTo).Rows[0][0] + "";
                            LinQ_ExecuteNonQuery(sql);
                        }
                //_db.SubmitChanges();
        ...
        /// <param name="dot"></param>
        /// <returns></returns>
        public bool XoaChia_SoPhatHanh(string Loai, int MaTo, decimal TuSoPhatHanh, decimal DenSoPhatHanh, int Nam, int Ky, int Dot)
        {
            try
            {
                if (Loai == "TG")
        ...
        public bool XoaChia_MLT(string Loai, int MaTo, decimal TuMLT, decimal DenMLT, int Nam, int Ky, int Dot)
        {
            try
            {
                if (Loai == "TG")
        ...
        public bool CheckGiaoByMLTsNam(decimal TuMLT, decimal DenMLT, int Nam)
        {
            return _db.HOADONs.Any(item => Convert.ToInt32(item.MALOTRINH) >= TuMLT && Convert.ToInt32(item.MALOTRINH) <= DenMLT && item.NAM == Nam && item.MaNV_HanhThu != null);
        }

        public bool CheckMLTByNamKyDot(string Loai, int MaTo, decimal MLT, int Nam, int Ky, int Dot)
        {
            if (Loai == "TG")
                return _db.HOADONs.Any(item => Convert.ToInt32(item.MAY) >= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).TuCuonGCS
                                        && Convert.ToInt32(item.MAY) <= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
                                        && Convert.ToInt32(item.MALOTRINH) == MLT && item.NAM == Nam && item.KY == Ky && item.DOT == Dot && item.GB >= 11 && item.GB <= 20);
            else
                if (Loai == "CQ")
                    return _db.HOADONs.Any(item => Convert.ToInt32(item.MAY) >= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).TuCuonGCS
                                    && Convert.ToInt32(item.MAY) <= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
                                    && Convert.ToInt32(item.MALOTRINH) == MLT && item.NAM == Nam && item.KY == Ky && item.DOT == Dot && item.GB > 20);
                else
                    if (Loai == "")
                        return _db.HOADONs.Any(item => Convert.ToInt32(item.MAY) >= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).TuCuonGCS
                                   && Convert.ToInt32(item.MAY) <= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
                                   && Convert.ToInt32(item.MALOTRINH) == MLT && item.NAM == Nam && item.KY == Ky && item.DOT == Dot);
                    else
                        return false;
        }
        ...
        public DataTable GetTongTon_To(int MaTo)
        {
            string sql = "declare @TuCuonGCS int;"
                        ...
                        + " where hd.MAY>=@TuCuonGCS and hd.MAY<=@DenCuonGCS"
        ...
        public DataTable GetTongTonDenKyDenNgay_Doi(int MaTo, int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            string sql = "declare @Nam int;"
                        ...
                        + " select '" + MaTo + "' as MaTo,TenTo=(select TenTo from TT_To where MaTo=" + MaTo + "),MAX(t1.TuMLT)as TuMLT,MAX(t1.DenMLT)as DenMLT,MAX(t1.TuSoPhatHanh)as TuSoPhatHanh,MAX(t1.DenSoPhatHanh)as DenSoPhatHanh,MAX(t1.TongHD)as TongHD,MAX(t1.TongCong)as TongCong,MAX(t1.TongHDThu)as TongHDThu,MAX(t1.TongCongThu)as TongCongThu,MAX(t1.TongHDTon)as TongHDTon,MAX(t1.TongGiaBanTon)as TongGiaBanTon,MAX(t1.TongCongTon)as TongCongTon,MAX(t1.TongCongTonBilling)as TongCongTonBilling from"
                        + " ((select min(MALOTRINH) as TuMLT,max(MALOTRINH) as DenMLT,min(SOPHATHANH) as TuSoPhatHanh,max(SOPHATHANH) as DenSoPhatHanh,count(DANHBA) as TongHD,sum(hd.TONGCONG) as TongCong,0 as TongHDThu,0 as TongCongThu,0 as TongHDTon,0 as TongGiaBanTon,0 as TongCongTon,0 as TongCongTonBilling"
                        + " from HOADON hd where hd.MAY>=@TuCuonGCS and hd.MAY<=@DenCuonGCS"
                        + " and (NAM<@Nam or (NAM=@Nam and KY<=@Ky)))"
                        + " union"
                        + " (select 0 as TuMLT,0 as DenMLT,0 as TuSoPhatHanh,0 as DenSoPhatHanh,0 as TongHD,0 as TongCong,count(DANHBA) as TongHDThu,sum(hd.TONGCONG) as TongCongThu,0 as TongHDTon,0 as TongGiaBanTon,0 as TongCongTon,0 as TongCongTonBilling"
                        + " from HOADON hd where hd.MAY>=@TuCuonGCS and hd.MAY<=@DenCuonGCS"
        ...
        public DataTable GetNangSuat_To(string Loai, int MaTo, int Nam, int Ky, int Dot)
        {
            if (Loai == "TG")
            {
                string sql = "declare @Nam int;"
                            ...
                            + " from HOADON hd left join TT_NguoiDung nd on hd.MaNV_HanhThu = nd.MaND"
                            + " where hd.MAY>=" + _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).TuCuonGCS + " and hd.MAY<=" + _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
        ...
        public DataTable getNangSuat_Doi(int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            return ExecuteQuery_DataTable("declare @NgayGiaiTrach date;"
                             + " set @NgayGiaiTrach='" + NgayGiaiTrach.ToString("yyyyMMdd") + "';"
                             + " select MAX(t1.TongHD)as TongHD,MAX(t1.TongGiaBan)as TongGiaBan,MAX(t1.TongCong)as TongCong,MAX(t1.TongHDThu)as TongHDThu,MAX(t1.TongGiaBanThu)as TongGiaBanThu,MAX(t1.TongCongThu)as TongCongThu,MAX(t1.TongHDTon)as TongHDTon,MAX(t1.TongGiaBanTon)as TongGiaBanTon,MAX(t1.TongCongTon)as TongCongTon"
                             + " ,MAX(t1.TongHDThucThu)as TongHDThucThu,MAX(t1.TongGiaBanThucThu)as TongGiaBanThucThu,MAX(t1.TongCongThucThu)as TongCongThucThu from"
                             + " ((select count(DANHBA) as TongHD,sum(hd.GIABAN) as TongGiaBan,sum(hd.TONGCONG) as TongCong,0 as TongHDThu,0 as TongGiaBanThu,0 as TongCongThu,0 as TongHDTon,0 as TongGiaBanTon,0 as TongCongTon,0 as TongHDThucThu,0 as TongGiaBanThucThu,0 as TongCongThucThu"
                             + " from HOADON hd where NAM=" + Nam + " and KY=" + Ky + ")"
                             + " union"
                             + " (select 0 as TongHD,0 as TongGiaBan,0 as TongCong,count(DANHBA) as TongHDThu,sum(hd.GIABAN) as TongGiaBanThu,sum(hd.TONGCONG) as TongCongThu,0 as TongHDTon,0 as TongGiaBanTon,0 as TongCongTon,0 as TongHDThucThu,0 as TongGiaBanThucThu,0 as TongCongThucThu"
                             + " from HOADON hd where NAM=" + Nam + " and KY=" + Ky + " and NGAYGIAITRACH is not null and CAST(NGAYGIAITRACH as date)<=@NgayGiaiTrach)"
                             + " union"
                             + " (select 0 as TongHD,0 as TongGiaBan,0 as TongCong,0 as TongHDThu,0 as TongGiaBanThu,0 as TongCongThu,count(DANHBA) as TongHDTon,sum(hd.GIABAN) as TongGiaBanTon,sum(hd.TONGCONG) as TongCongTon,0 as TongHDThucThu,0 as TongGiaBanThucThu,0 as TongCongThucThu"
                             + " from HOADON hd where NAM=" + Nam + " and KY=" + Ky + " and (NGAYGIAITRACH is null or CAST(NGAYGIAITRACH as date)>@NgayGiaiTrach))"
                             + " union"
                             + " (select 0 as TongHD,0 as TongGiaBan,0 as TongCong,0 as TongHDThu,0 as TongGiaBanThu,0 as TongCongThu,0 as TongHDTon,0 as TongGiaBanTon,0 as TongCongTon,count(DANHBA) as TongHDThucThu,sum(hd.GIABAN) as TongGiaBanThucThu,sum(hd.TONGCONG) as TongCongThucThu"
                             + " from HOADON hd where NAM=" + Nam + " and KY=" + Ky + " and NGAYGIAITRACH is not null)) t1");
        }
        ...
        public DataTable GetBaoCaoTongHop_NV(string Loai, int MaTo, int Nam, int Ky, DateTime NgayGiaiTrachNow, DateTime NgayGiaiTrachOld, DateTime NgayGiaiTrachFuture)
        {
            if (Loai == "TG")
            {
                string sql = "declare @NgayGiaiTrachNow date;"
                        ...
                        + " from HOADON hd left join TT_NguoiDung nd on hd.MaNV_HanhThu = nd.MaND where hd.MAY>=" + _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).TuCuonGCS + " and hd.MAY<=" + _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
            ...
            if (Loai == "TG")
            {
                ...
                if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                {
                    var query = from item in _db.HOADONs
                                ...
                                && item.KhoaTienDu == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                ...
                if (Loai == "CQ")
                {
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                    && item.KhoaTienDu == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                    orderby item.MaNV_DangNgan ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                                    {
        ...
        //                        && Convert.ToInt32(item.MAY) <= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
        //                        && _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
        //                        && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
        //                    orderby MaTo ascending
        //                    group item by MaTo into itemGroup
        //                    select new
        //                    {
        ...
        //                            && Convert.ToInt32(item.MAY) <= _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DenCuonGCS
        //                            && _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
        //                            && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
        //                        orderby MaTo ascending
        //                        group item by MaTo into itemGroup
        //                        select new
        //                        {
        ...
        {
            DataTable dt = new DataTable();
            string sql = "select MaNV=MaNV_DangNgan,HoTen=(select HoTen from TT_NguoiDung where MaND=MaNV_DangNgan),'LoaiHoaDon'=N'Giấy',TongHD=COUNT(ID_HOADON),SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong,"
            ...
            sql = "select MaNV=MaNV_DangNgan,HoTen=(select HoTen from TT_NguoiDung where MaND=MaNV_DangNgan),'LoaiHoaDon'=N'Điện Tử',TongHD=COUNT(ID_HOADON),SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong,"
                        + " TongTienDu=SUM(TienDu),TongTienMat=SUM(TienMat)"
                        + " from HOADON where MaNV_DangNgan=" + MaNV_DangNgan + " and NAM=" + Nam + " and KY=" + Ky + " and (NAM>2020 or(NAM=2020 and KY>=7)) and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "'"
                        + " group by MaNV_DangNgan";
            dt.Merge(ExecuteQuery_DataTable(sql));
        ...
        public DataTable GetTongHopDangNganDoi(string Loai, DateTime NgayGiaiTrach)
        {
            if (Loai == "CK")
            {
                ...
                var query = from item in _db.HOADONs
                            ...
                            && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                ...
                if (Loai == "TG")
                {
                    ...
                    var query = from item in _db.HOADONs
                                where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                    && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                    && item.KhoaTienDu == false
                                group item by item.DangNgan_ChuyenKhoan into itemGroup
                                select new
                                {
                    ...
                    if (Loai == "CQ")
                    {
                        ...
                        var query = from item in _db.HOADONs
                                    where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                        && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                        && item.KhoaTienDu == false
                                    group item by item.DangNgan_ChuyenKhoan into itemGroup
                                    select new
                                    {
        ...
        public DataTable GetTongHopDangNganDoi_PhanKyLon(string Loai, int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            if (Loai == "CK")
            {
                ...
                var query = from item in _db.HOADONs
                            where item.DangNgan_ChuyenKhoan == true///chỉ lấy ngân hàng
                            && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                            && item.KhoaTienDu == false
                            group item by item.DangNgan_ChuyenKhoan into itemGroup
                            select new
                            {
                ...
                if (Loai == "TG")
                {
                    ...
                    var query = from item in _db.HOADONs
                                where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                    && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                    && item.KhoaTienDu == false
                                group item by item.DangNgan_ChuyenKhoan into itemGroup
                                select new
                                {
                    ...
                    if (Loai == "CQ")
                    {
                        ...
                        var query = from item in _db.HOADONs
                                    where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                        && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                        && item.KhoaTienDu == false
                                    group item by item.DangNgan_ChuyenKhoan into itemGroup
                                    select new
                                    {
        ...
        public DataTable GetTongHopDangNganDoi_PhanKyNho(string Loai, int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            if (Loai == "CK")
            {
                ...
                var query = from item in _db.HOADONs
                            where item.DangNgan_ChuyenKhoan == true///chỉ lấy ngân hàng
                            && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || item.NAM == Nam && item.KY < Ky) && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                            && item.KhoaTienDu == false
                            group item by item.DangNgan_ChuyenKhoan into itemGroup
                            select new
                            {
                ...
                if (Loai == "TG")
                {
                    ...
                    var query = from item in _db.HOADONs
                                where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                    && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || item.NAM == Nam && item.KY < Ky) && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                    && item.KhoaTienDu == false
                                group item by item.DangNgan_ChuyenKhoan into itemGroup
                                select new
                                {
                    ...
                    if (Loai == "CQ")
                    {
                        ...
                        var query = from item in _db.HOADONs
                                    where item.DangNgan_ChuyenKhoan == false///ngoài ngân hàng ra
                                        && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || item.NAM == Nam && item.KY < Ky) && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                        && item.KhoaTienDu == false
                                    group item by item.DangNgan_ChuyenKhoan into itemGroup
                                    select new
                                    {
                ...
                default:
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        ...
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                        && item.DangNgan_ChuyenKhoan == true
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                                    {
                        ...
                        var queryQTP = from item in _db.HOADONs
                                       where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                           && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                           && item.DangNgan_Quay == true && Convert.ToInt32(item.DOT) >= 1 && Convert.ToInt32(item.DOT) <= 15
                                       //orderby item.STT ascending
                                       group item by item.MaNV_DangNgan into itemGroup
                                       select new
                                       {
                        ...
                        var queryQTB = from item in _db.HOADONs
                                       where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                           && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                           && item.DangNgan_Quay == true && Convert.ToInt32(item.DOT) >= 16 && Convert.ToInt32(item.DOT) <= 30
                                       //orderby item.STT ascending
                                       group item by item.MaNV_DangNgan into itemGroup
                                       select new
                                       {
        ...
        public DataTable GetTongHopDangNganChiTiet(string Loai, int MaTo, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            switch (Loai)
            {
                case "TG":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                ...
                case "CQ":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                                    {
                ...
                default:
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                                    {
        ...
        public DataTable GetTongHopDangNganChiTiet_PhanKyLon(string Loai, int MaTo, int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            switch (Loai)
            {
                case "TG":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                ...
                case "CQ":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                ...
                default:
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && item.NAM == Nam && item.KY == Ky && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
            ...
            switch (Loai)
            {
                ...
                default:
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || (item.NAM == Nam && item.KY < Ky)) && (item.NAM < 2020 || (item.NAM == 2020 && item.KY < 7)) && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
        ...
        public DataTable GetTongHopDangNganChiTiet_PhanKyNho_Giay(string Loai, int MaTo, int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            switch (Loai)
            {
                case "TG":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || (item.NAM == Nam && item.KY < Ky)) && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB >= 11 && item.GB <= 20
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                ...
                case "CQ":
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || (item.NAM == Nam && item.KY < Ky)) && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null && item.GB > 20
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
                ...
                default:
                    ...
                    if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
                    {
                        var query = from item in _db.HOADONs
                                    where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                        && item.ChuyenNoKhoDoi == false && (item.NAM < Nam || (item.NAM == Nam && item.KY < Ky)) && (item.NAM < 2020 || (item.NAM == 2020 && item.KY < 7)) && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                        && item.KhoaTienDu == false
                                    //orderby item.STT ascending
                                    group item by item.MaNV_DangNgan into itemGroup
                                    select new
        ...
        public DataTable GetTongHopDangNganChiTiet_PhanKyNho_DienTu(string Loai, int MaTo, int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            switch (Loai)
            {
                case "TG":
        ...
        public DataTable GetTongHopDangNganChiTiet_Giay(int MaTo, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            ///Tổ Văn Phòng
            if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
            {
                var query = from item in _db.HOADONs
                            where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                && item.ChuyenNoKhoDoi == false && (item.NAM < 2020 || (item.NAM == 2020 && item.KY < 7)) && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                && item.KhoaTienDu == false
                            //orderby item.STT ascending
                            group item by item.MaNV_DangNgan into itemGroup
                            select new
        ...
        public DataTable GetTongHopDangNganChiTiet_DienTu(int MaTo, DateTime NgayGiaiTrach)
        {
            ...
            if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
            {
                ...
                var query = from item in _db.HOADONs
                            where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                && item.ChuyenNoKhoDoi == false && (item.NAM > 2020 || (item.NAM == 2020 && item.KY >= 7)) && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                && item.KhoaTienDu == false && item.DangNgan_ChuyenKhoan == true
                            //orderby item.STT ascending
                            group item by item.MaNV_DangNgan into itemGroup
                            select new
                            {
        ...
        public DataTable GetTongHopDangNganChiTiet_DienTu(int MaTo, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            ///Tổ Văn Phòng
            if (_db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).HanhThu == false && _db.TT_Tos.SingleOrDefault(itemTo => itemTo.MaTo == MaTo).DongNuoc == false)
            {
                var query = from item in _db.HOADONs
                            where _db.TT_NguoiDungs.Any(itemND => itemND.MaTo == MaTo && itemND.MaND == item.MaNV_DangNgan)///Kiểm tra nhân viên đăng ngân thuộc tổ
                                && item.ChuyenNoKhoDoi == false && (item.NAM > 2020 || (item.NAM == 2020 && item.KY >= 7)) && item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.MaNV_DangNgan != null
                                && item.KhoaTienDu == false
                            //orderby item.STT ascending
                            group item by item.MaNV_DangNgan into itemGroup
                            select new
        ...
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and GB>=1 and GB<=20 and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThuTG_PhanKyLon(int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and GB>=1 and GB<=20 and NAM=" + Nam + " and KY=" + Ky + " and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThuTG_PhanKyNho(int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and GB>=1 and GB<=20 and (NAM<" + Nam + " or (NAM=" + Nam + " and KY<" + Ky + ")) and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu(DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }

        public DataTable GetTongHopDangNganChiTiet_HanhThu(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and CAST(NGAYGIAITRACH as date)>='" + FromNgayGiaiTrach.ToString("yyyyMMdd") + "' and CAST(NGAYGIAITRACH as date)<='" + ToNgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu_PhanKyLon(int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and NAM=" + Nam + " and KY=" + Ky + " and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }

        public DataTable GetTongHopDangNganChiTiet_HanhThu_PhanKyLon(int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and NAM=" + Nam + " and KY=" + Ky + " and CAST(NGAYGIAITRACH as date)>='" + FromNgayGiaiTrach.ToString("yyyyMMdd") + "' and CAST(NGAYGIAITRACH as date)<='" + ToNgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu_PhanKyNho_Giay(int Nam, int Ky, DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and (NAM<" + Nam + " or (NAM=" + Nam + " and KY<" + Ky + ")) and (NAM<2020 or(NAM=2020 and KY<7)) and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }

        public DataTable GetTongHopDangNganChiTiet_HanhThu_PhanKyNho_Giay(int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and (NAM<" + Nam + " or (NAM=" + Nam + " and KY<" + Ky + ")) and (NAM<2020 or(NAM=2020 and KY<7)) and CAST(NGAYGIAITRACH as date)>='" + FromNgayGiaiTrach.ToString("yyyyMMdd") + "' and CAST(NGAYGIAITRACH as date)<='" + ToNgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu_PhanKyNho_DienTu(int Nam, int Ky, DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu_Giay(DateTime NgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        ...
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and (NAM<2020 or (NAM=2020 and KY<7)) and CAST(NGAYGIAITRACH as date)='" + NgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }

        public DataTable GetTongHopDangNganChiTiet_HanhThu_Giay(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
                        + " (select MaNV_DangNgan,COUNT(*)as TongHD,SUM(GIABAN)as TongGiaBan,SUM(THUE)as TongThueGTGT,SUM(PHI)as TongPhiBVMT,SUM(ThueGTGT_TDVTN)as TongPhiBVMT_Thue,SUM(TONGCONG)as TongCong"
                        + " from HOADON where ChuyenNoKhoDoi=0 and KhoaTienDu=0 and (NAM<2020 or (NAM=2020 and KY<7)) and CAST(NGAYGIAITRACH as date)>='" + FromNgayGiaiTrach.ToString("yyyyMMdd") + "' and CAST(NGAYGIAITRACH as date)<='" + ToNgayGiaiTrach.ToString("yyyyMMdd") + "' and MaNV_DangNgan is not null group by MaNV_DangNgan)hd on hd.MaNV_DangNgan=nd.MaND"
                        + " order by nd.STT asc";
            return ExecuteQuery_DataTable(sql);
        }
        ...
        public DataTable GetTongHopDangNganChiTiet_HanhThu_DienTu(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "select MaND as MaNV,STT,HoTen,CAST(0 as bit) as ChuyenKhoan,TongHD,TongGiaBan,TongThueGTGT,TongPhiBVMT,TongPhiBVMT_Thue,TongCong from"
                        + " (select MaND,STT,HoTen from TT_NguoiDung where HanhThu=1)nd"
                        + " left join"
        ...
        public DataTable getTongHopDangNgan_KeToan_TheoNgay(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            ...
            string sql = "declare @FromNgayGiaiTrach date"
                        ...
                        + " where CAST(NGAYGIAITRACH as date)>=@FromNgayGiaiTrach and CAST(NGAYGIAITRACH as date)<=@ToNgayGiaiTrach and MaNV_DangNgan is not null and KY=MONTH(@ToNgayGiaiTrach) and NAM=YEAR(@ToNgayGiaiTrach) and ChuyenNoKhoDoi=0"
                        + " group by CAST(NGAYGIAITRACH as date)"
                        + " union all"
        ...
        public DataTable getTongHopDangNgan_KeToan_TheoThang(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            string sql = "declare @FromNgayGiaiTrach date"
                        ...
                        + " where CAST(NGAYGIAITRACH as date)>=@FromNgayGiaiTrach and CAST(NGAYGIAITRACH as date)<=@ToNgayGiaiTrach and MaNV_DangNgan is not null and KY<MONTH(NGAYGIAITRACH) and NAM=YEAR(@ToNgayGiaiTrach) and ChuyenNoKhoDoi=0"
                        + " group by RIGHT('0' + CAST(MONTH(NGAYGIAITRACH) as varchar(2)),2)+'/'+CONVERT(varchar(4),YEAR(NGAYGIAITRACH))"
                        + " union all"
        ...
        public DataTable GetDSDangNganDum(int MaNV_HanhThu, Nullable<int> MaNV_DangNgan, int Nam, int Ky, int Dot, DateTime NgayGiaiTrach)
        {
            ...
            {
                var query = from item in _db.HOADONs
                            where item.MaNV_HanhThu == MaNV_HanhThu && item.MaNV_DangNgan == MaNV_DangNgan && item.NAM == Nam && item.KY == Ky && item.DOT == Dot && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                            orderby item.MALOTRINH ascending
                            select new
                            {
                                item.NGAYGIAITRACH,
            ...
            {
                var query = from item in _db.HOADONs
                            where item.MaNV_HanhThu == MaNV_HanhThu && item.MaNV_DangNgan == null && item.NAM == Nam && item.KY == Ky && item.DOT == Dot && item.NGAYGIAITRACH.Value.Date == NgayGiaiTrach.Date && item.MaNV_DangNgan != null
                            orderby item.MALOTRINH ascending
                            select new
                            {
                                item.NGAYGIAITRACH,
        ...
        public DataTable GetDSDangNgan_KeToan_Chot2019(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach)
        {
            var query = from item in _db.HOADONs
                        ...
                        select new
                        {
                            ...
                            ThueGTGT = item.THUE,
                            PhiBVMT = item.PHI,
                            PhiBVMT_Thue = item.ThueGTGT_TDVTN,
                            item.TONGCONG,
        ...
        public DataTable getDS_DangNgan(DateTime FromNgayGiaiTrach, DateTime ToNgayGiaiTrach, int FromDot, int ToDot)
        {
            var query = from item in _db.HOADONs
                        join itemND in _db.TT_NguoiDungs on item.MaNV_HanhThu equals itemND.MaND into tableND
                        from itemtableND in tableND.DefaultIfEmpty()
                        where item.NGAYGIAITRACH.Value.Date >= FromNgayGiaiTrach.Date && item.NGAYGIAITRACH.Value.Date <= ToNgayGiaiTrach.Date
                        && item.KhoaTienDu == false && Convert.ToInt32(item.MAY) >= FromDot && Convert.ToInt32(item.MAY) <= ToDot
                        orderby item.MALOTRINH ascending
                        select new
                        {
                            item.NGAYGIAITRACH,
        ...
        public DataTable GetDSDangNganChuyenKhoan(string Loai, int MaNV_DangNgan, DateTime TuNgayGiaiTrach, DateTime DenNgayGiaiTrach, int FromDot, int ToDot)
        {
            if (Loai == "TG")
            {
                var query = from itemHD in _db.HOADONs
                            ...
                            && itemHD.MaNV_DangNgan == MaNV_DangNgan && itemHD.DOT >= FromDot && itemHD.DOT <= ToDot && itemHD.GB >= 11 && itemHD.GB <= 20
                            select new
                            {
                                itemHD.NGAYGIAITRACH,
                                itemHD.SOHOADON,
                ...
                if (Loai == "CQ")
                {
                    var query = from itemHD in _db.HOADONs
                                ...
                                from itemtableND in tableND.DefaultIfEmpty()
                                where itemHD.DangNgan_ChuyenKhoan == true && itemHD.TienMat == null && itemHD.NGAYGIAITRACH.Value.Date >= TuNgayGiaiTrach.Date && itemHD.NGAYGIAITRACH.Value.Date <= DenNgayGiaiTrach.Date
                               && itemHD.MaNV_DangNgan == MaNV_DangNgan && itemHD.DOT >= FromDot && itemHD.DOT <= ToDot && itemHD.GB > 20
                                select new
                                {
                                    itemHD.NGAYGIAITRACH,
                                    itemHD.SOHOADON,
                    ...
                    if (Loai == "")
                    {
                        var query = from itemHD in _db.HOADONs
                                    ...
                                    from itemtableND in tableND.DefaultIfEmpty()
                                    where itemHD.DangNgan_ChuyenKhoan == true && itemHD.TienMat == null && itemHD.NGAYGIAITRACH.Value.Date >= TuNgayGiaiTrach.Date && itemHD.NGAYGIAITRACH.Value.Date <= DenNgayGiaiTrach.Date
                                   && itemHD.MaNV_DangNgan == MaNV_DangNgan && itemHD.DOT >= FromDot && itemHD.DOT <= ToDot
                                    select new
                                    {
                                        itemHD.NGAYGIAITRACH,
                                        itemHD.SOHOADON,
        ...
        public DataTable GetDSTon_To(int MaTo, int SoKy)
        {
            string sql = "declare @TuCuonGCS int;"
                        ...
                        + " THUE as ThueGTGT,PHI as PhiBVMT,TONGCONG,CODE,nd.HoTen as HanhThu,tto.TenTo as 'To',GiaBieu=GB,DinhMuc=DM,DinhMucHN,CoDH,Phuong,Quan"
                        + " from HOADON hd"
                        + " left join TT_NguoiDung nd on nd.MaND=hd.MaNV_HanhThu"
        ...
        public DataTable getDSTonByDanhBo_DCHD_ChuaUpdateTCT(string DanhBo, int FromDot, int ToDot)
        {
            var query = from itemHD in _db.HOADONs
                        join itemND in _db.TT_NguoiDungs on itemHD.MaNV_HanhThu equals itemND.MaND into tableND
                        from itemtableND in tableND.DefaultIfEmpty()
                        join itemDC in _db.DIEUCHINH_HDs on itemHD.ID_HOADON equals itemDC.FK_HOADON into tableDC
                        from itemtableDC in tableDC.DefaultIfEmpty()
                        where itemHD.DANHBA == DanhBo && itemHD.DOT >= FromDot && itemHD.DOT <= ToDot && itemHD.NGAYGIAITRACH == null
                         && (itemtableDC == null || itemtableDC.UpdatedHDDT == true || (itemtableDC.TONGCONG_END != null && (itemHD.NAM > 2022 || (itemHD.NAM == 2022 && itemHD.KY >= 5))))
                        orderby itemHD.ID_HOADON descending
                        select new
                        {
        ...
        public DataTable getDSTonByDanhBo_TruHoNgheo(string DanhBo, int FromDot, int ToDot)
        {
            var query = from itemHD in _db.HOADONs
                        join itemND in _db.TT_NguoiDungs on itemHD.MaNV_HanhThu equals itemND.MaND into tableND
                        from itemtableND in tableND.DefaultIfEmpty()
                        join itemDC in _db.DIEUCHINH_HDs on itemHD.ID_HOADON equals itemDC.FK_HOADON into tableDC
                        from itemtableDC in tableDC.DefaultIfEmpty()
                        where itemHD.DANHBA == DanhBo && itemHD.DOT >= FromDot && itemHD.DOT <= ToDot && itemHD.NGAYGIAITRACH == null && (itemHD.GB != 10 && itemHD.DinhMucHN == null)
                        && (itemtableDC == null || itemtableDC.UpdatedHDDT == true || (itemtableDC.TONGCONG_END != null && (itemHD.NAM > 2022 || (itemHD.NAM == 2022 && itemHD.KY >= 5))))
                        orderby itemHD.ID_HOADON descending
                        select new
                        {
