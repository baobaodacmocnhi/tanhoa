    ...
    class CDangKyHD0 : CDAL
    {
        ...
        public DataTable GetDS(int MaNV, int Nam)
        {
            string sql = "declare @nam int;"
                        ...
                        + " set @nam="+Nam+";"
                        + " set @MaNV="+MaNV+";"
                        + " select ky1.MaNV,ky1.HoTen,ky1.DanhBo,ky1.DiaChi,ky1.TIEUTHU as Ky1,ky2.TIEUTHU as Ky2,ky3.TIEUTHU as Ky3,"
                        ...
                        + " from"
                        + " (select MaNV,nd.HoTen,dk.DanhBo,hd.SO+' '+hd.DUONG as DiaChi,TIEUTHU"
                        + " from TT_DangKyHD0 dk,HOADON hd,TT_NguoiDung nd"
                        + " where dk.DanhBo=hd.DANHBA and dk.MaNV=nd.MaND and dk.MaNV=@MaNV and NAM=@nam and KY=1) ky1"
                        + " left join"
