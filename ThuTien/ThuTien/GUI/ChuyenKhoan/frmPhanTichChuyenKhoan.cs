            ...
            if (chkNgayKiemTra.Checked == true)
            {
                ...
                if (cmbTo_PhanTich.SelectedIndex == 0)
                {
                    ...
                    if (cmbKy_PhanTich.SelectedIndex == 0)
                    {
                        for (int i = 1; i < cmbTo_PhanTich.Items.Count; i++)
                            dt.Merge(_cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), ((TT_To)cmbTo_PhanTich.Items[i]).MaTo, int.Parse(cmbNam_PhanTich.SelectedValue.ToString()),dateGiaiTrach.Value));
                    }
                    else
                        ///chọn 1 kỳ
                        if (cmbKy_PhanTich.SelectedIndex > 0)
                        {
                            for (int i = 1; i < cmbTo_PhanTich.Items.Count; i++)
                                dt.Merge(_cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), ((TT_To)cmbTo_PhanTich.Items[i]).MaTo, int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString()), dateGiaiTrach.Value));
                        }
                ...
                ///chọn 1 tổ
                    ...
                    if (cmbTo_PhanTich.SelectedIndex > 0)
                        ///chọn tất cả kỳ
                        if (cmbKy_PhanTich.SelectedIndex == 0)
                            dgvTo_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(cmbTo_PhanTich.SelectedValue.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), dateGiaiTrach.Value);
                        else
                            ///chọn 1 kỳ
                            if (cmbKy_PhanTich.SelectedIndex > 0)
                                dgvTo_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(cmbTo_PhanTich.SelectedValue.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString()), dateGiaiTrach.Value);
            }
            else
            {
                ///chọn tất cả tổ
                if (cmbTo_PhanTich.SelectedIndex == 0)
                {
                    ...
                    {
                        for (int i = 1; i < cmbTo_PhanTich.Items.Count; i++)
                            dt.Merge(_cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), ((TT_To)cmbTo_PhanTich.Items[i]).MaTo, int.Parse(cmbNam_PhanTich.SelectedValue.ToString())));
                    }
                    else
                        ///chọn 1 kỳ
                        if (cmbKy_PhanTich.SelectedIndex > 0)
                        {
                            for (int i = 1; i < cmbTo_PhanTich.Items.Count; i++)
                                dt.Merge(_cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), ((TT_To)cmbTo_PhanTich.Items[i]).MaTo, int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString())));
                        }
                    dgvTo_PhanTich.DataSource = dt;
                }
                ///chọn 1 tổ
                    ...
                    if (cmbTo_PhanTich.SelectedIndex > 0)
                        ///chọn tất cả kỳ
                        if (cmbKy_PhanTich.SelectedIndex == 0)
                            dgvTo_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(cmbTo_PhanTich.SelectedValue.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()));
                        else
                            ///chọn 1 kỳ
                            if (cmbKy_PhanTich.SelectedIndex > 0)
                                dgvTo_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(cmbTo_PhanTich.SelectedValue.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString()));
            }
            CountdgvTo_PhanTich();
        }
        ...
        private void dgvTo_PhanTich_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvTo_PhanTich.RowCount > 0)
            {
                if (chkNgayKiemTra.Checked == true)
                {
                    ///chọn tất cả kỳ
                    if (cmbKy_PhanTich.SelectedIndex == 0)
                        dgvNhanVien_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan_NV(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(dgvTo_PhanTich.CurrentRow.Cells["MaTo"].Value.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), dateGiaiTrach.Value);
                    else
                        ///chọn 1 kỳ
                        if (cmbKy_PhanTich.SelectedIndex > 0)
                            dgvNhanVien_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan_NV(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(dgvTo_PhanTich.CurrentRow.Cells["MaTo"].Value.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString()), dateGiaiTrach.Value);
                }
                else
                {
                    ///chọn tất cả kỳ
                    if (cmbKy_PhanTich.SelectedIndex == 0)
                        dgvNhanVien_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan_NV(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(dgvTo_PhanTich.CurrentRow.Cells["MaTo"].Value.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()));
                    else
                        ///chọn 1 kỳ
                        if (cmbKy_PhanTich.SelectedIndex > 0)
                            dgvNhanVien_PhanTich.DataSource = _cHoaDon.GetPhanTichChuyenKhoan_NV(cmbDichVuThu_PhanTich.SelectedValue.ToString(), int.Parse(dgvTo_PhanTich.CurrentRow.Cells["MaTo"].Value.ToString()), int.Parse(cmbNam_PhanTich.SelectedValue.ToString()), int.Parse(cmbKy_PhanTich.SelectedItem.ToString()));
                }
