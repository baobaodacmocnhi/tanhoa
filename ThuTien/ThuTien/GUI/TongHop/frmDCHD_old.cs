...
{
    public partial class frmDCHD_old : Form
    {
        string _mnu = "mnuDCHD";
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (CNguoiDung.CheckQuyen(_mnu, "Them"))
            {
                ...
                if (dgvHoaDon.RowCount > 1)
                {
                    ...
                    {
                        string loai;
                        if (_cTamThu.CheckExist(dgvHoaDon["SoHoaDon", index].Value.ToString(),out loai))
                        {
                    ...
                    {
                        string loai;
                        if (_cTamThu.CheckExist(dgvHoaDon["SoHoaDon", 0].Value.ToString(), out loai))
                        {
                            MessageBox.Show("Hóa Đơn này đã Tạm Thu(" + loai + ")", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            return;
                        }
