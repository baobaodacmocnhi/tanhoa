select * from
                             ...
                             ,MaKQDN=(select count(*) from TT_DongNuoc a,TT_KQDongNuoc b where a.Huy=0 and b.DanhBo=hd.DANHBA and b.MoNuoc=0 and b.TroNgaiMN=0 and a.MaDN=b.MaDN)
                             ...
                             from HOADON hd
                             where (NAM< 2023  or (NAM= 2023  and Ky<= 2 )) and DOT>= 7  and DOT<= 7  and MaNV_HanhThu=17
