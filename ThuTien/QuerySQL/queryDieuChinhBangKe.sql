select * from TT_BangKe where DanhBo='13263414890'
select * from TT_TienDu where DanhBo='13263414890'
select * from TT_TienDuLichSu where DanhBo='13263414890' and CAST(CreateDate as date)='2018-05-28'
--update TT_BangKe set SoTien=SoTien-118450 where MaBK=25740
--update TT_TienDu set SoTien=12190 where DanhBo='13263414890'
