...
{
    public partial class pBauCuDoanThanhNien : System.Web.UI.Page
    {
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                title.Text = "..: KIỂM PHIẾU BẦU BAN CHẤP HÀNH ĐOÀN CƠ SỞ, NHIỆM KỲ 2022-2027 :..";
                lbKetqua.Text = "KẾT QUẢ BẦU BAN CHẤP HÀNH CÔNG ĐOÀN CƠ SỞ, NHIỆM KỲ 2022-2027";
            }
