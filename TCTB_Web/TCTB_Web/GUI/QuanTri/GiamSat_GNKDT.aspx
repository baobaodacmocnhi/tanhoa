<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="GiamSat_GNKDT.aspx.cs" Inherits="TCTB_Web.WebForm2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="form">
    <div class="title">GIÁM SÁT P.GNKDT</div>
        <div>
        ...
        <div>
            ...
            <span style="margin-left: 10px">
                <asp:Button ID="btnSua" runat="server" Text="Sửa" onclick="btnSua_Click" /></span> <span style="margin-left: 10px">
                    <asp:Button ID="btnXoa" runat="server" Text="Xóa" 
                onclick="btnXoa_Click" /></span>
        </div>
        <div style="margin-top:30px">
            <asp:GridView ID="dgvNhanVien" runat="server" AutoGenerateColumns="False"
                OnSelectedIndexChanged="dgvNhanVien_SelectedIndexChanged" 
                DataKeyNames="ID">
                <Columns>
