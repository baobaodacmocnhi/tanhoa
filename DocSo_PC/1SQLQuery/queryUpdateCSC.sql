select ds.DanhBa,bd.ChiSo,ds.CSCu,Quan,CodeMoi from BienDong bd,DocSo ds
where ds.DocSoID=bd.BienDongID
and ds.Nam=2024 and ds.ky=1 and ds.dot=8
...
and DocSoID in (select ds.DocSoID from BienDong bd,DocSo ds where ds.DocSoID=bd.BienDongID and ds.Nam=2024 and ds.ky=1 and ds.dot=8
and ds.CSCu!=bd.ChiSo and CSCu=0)
