...
,SLTieuThuDieuChinh=(select SUM(TieuThuLo)*-1 from ChiSoLo_DanhBo where nam=2021 and ky=11 and dot=@dot+1 and MaDon is not null)-(select SUM(TieuThuLoConLai)*-1 from ChiSoLo_DanhBo where nam=2021 and ky=11 and dot=@dot and MaDon is not null)
union all
select Dot=@dot+2,
...
,SLTieuThuDieuChinh=(select SUM(TieuThuLo)*-1 from ChiSoLo_DanhBo where nam=2021 and ky=11 and dot=@dot+2 and MaDon is not null)-(select SUM(TieuThuLoConLai)*-1 from ChiSoLo_DanhBo where nam=2021 and ky=11 and dot=@dot and MaDon is not null)
