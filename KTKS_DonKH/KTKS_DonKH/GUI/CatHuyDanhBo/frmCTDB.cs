...
namespace KTKS_DonKH.GUI.CatHuyDanhBo
{
    public partial class frmCTDB : Form
    {
        ...
        public void LoadCTDB(CHDB_ChiTietCatTam ctctdb)
        {
            ...
            dgvHinh.Rows.Clear();
            foreach (CHDB_ChiTietCatTam_Hinh item in ctctdb.CHDB_ChiTietCatTam_Hinhs.OrderByDescending(o => o.CreateDate).ToList())
            {
        ...
        private void frmCTDB_KeyDown(object sender, KeyEventArgs e)
        {
