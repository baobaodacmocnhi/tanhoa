...
namespace KTKS_DonKH.GUI.ThuTraLoi
{
    public partial class frmToTrinh2021 : Form
    {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            if (_cttt != null)
            {
                ...
                if (tabControl.SelectedTab.Name == "tabTTKH")
                {
                    ...
                    if ((_cttt.VeViec.Contains("Hạ cỡ") || _cttt.VeViec.Contains("hộp bảo vệ")) && bgdTQ.ChucVu.ToUpper().Contains("PHÓ GIÁM ĐỐC"))
                    {
        ...
        private void frmToTrinh2021_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                if (_cttt != null)
                {
                    if (CTaiKhoan.CheckQuyen(_mnu, "Sua"))
                    {
                        ...
                        {
                            ToTrinh_ChiTiet_Hinh en = _cTT.get_Hinh(int.Parse(dgvHinh.CurrentRow.Cells["ID_Hinh"].Value.ToString()));
