...
namespace KTKS_DonKH.GUI.DonTu
{
    public partial class frmNhanDonTu : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                if (CTaiKhoan.CheckQuyen(_mnu, "Them"))
                {
                    ...
                    entity.YeuCauScan = chkYeuCauScan.Checked;
            ...
            try
            {
                if (CTaiKhoan.CheckQuyen(_mnu, "Sua"))
                {
                    if (_dontu != null)
                    {
                        ...
                        ///
                        _dontu.YeuCauScan = chkYeuCauScan.Checked;
        ...
        public void InBienNhan(LinQ.DonTu entity)
        {
            try
            {
                ...
                if (entity.DonTu_ChiTiets.Count == 1)
                {
                    ...
                    if (entity.DonTu_ChiTiets.SingleOrDefault().MLT != null && entity.DonTu_ChiTiets.SingleOrDefault().MLT.Trim() != "")
        ...
        private void btnCapNhatDoiTac_Click(object sender, EventArgs e)
        {
            try
            {
                if (CTaiKhoan.CheckQuyen(_mnu, "Sua"))
                {
                    ...
                    {
                        string error;
                        bool result = _wsEContract.updateDoiTac(txtCCCD.Text.Trim(), txtEmail.Text.Trim(), txtDienThoaiMoi.Text.Trim(), txtHoTenMoi.Text.Trim(), txtMST.Text.Trim(), "tanho@2022", out error);
                        if (result)
                        {
                            MessageBox.Show("Thành công", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
        ...
        private void btnCapNhatHieuLuc_Click(object sender, EventArgs e)
        {
            try
            {
                if (CTaiKhoan.CheckQuyen(_mnu, "Sua"))
        ...
        private void btnChonFile_Click(object sender, EventArgs e)
        {
            try
            {
                if (CTaiKhoan.CheckQuyen(_mnuScan, "Sua"))
                {
                    if (_dontu != null)
                    {
                        OpenFileDialog dialog = new OpenFileDialog();
