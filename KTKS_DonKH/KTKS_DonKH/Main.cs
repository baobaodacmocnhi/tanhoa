...
namespace KTKS_DonKH
{
    public partial class Main : RibbonForm
    {
        ...
        private void ribbonButton2_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
            Form frm = new frmBaoCaoBamChi();
            frm.MdiParent = this;
            frm.Show();
            StripStatus_Form.Text = "Đang mở Form: " + frm.Text;
        }

        private void ribbtnCapNhatDonKH_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
            Form frm = new frmCapNhatDonTKH();
            frm.MdiParent = this;
            frm.Show();
            StripStatus_Form.Text = "Đang mở Form: " + frm.Text;
        }
        ...
        private void ribbtnVeViecTTTL_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
            Form frm = new frmVeViecTTTL();
            frm.MdiParent = this;
            frm.Show();
            StripStatus_Form.Text = "Đang mở Form: " + frm.Text;
        }
        ...
        private void ribbtnDSTruyThuTienNuoc_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
        ...
        private void ribbtnGianLan_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
            Form frm = new frmGianLan();
            frm.MdiParent = this;
            frm.Show();
            StripStatus_Form.Text = "Đang mở Form: " + frm.Text;
        }

        private void ribbtnVeViecCHDB_Click(object sender, EventArgs e)
        {
            foreach (Form item in this.MdiChildren)
                item.Close();
            Form frm = new frmLyDoCHDB();
            frm.MdiParent = this;
            frm.Show();
            StripStatus_Form.Text = "Đang mở Form: " + frm.Text;
        }
