...
namespace KTKS_DonKH
{
    public partial class frmMain : Form
    {
        ...
        private void mnuDieuChinhHangLoat_Click(object sender, EventArgs e)
        {
            if (CTaiKhoan.CheckQuyen("mnuDieuChinhHangLoat", "Xem"))
            {
                frmDieuChinhHangLoat frm = new frmDieuChinhHangLoat();
                OpenForm(frm);
            }
            else
                MessageBox.Show("Bạn không có quyền Xem Form này", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void mnuCapDinhMucNuocCCCD_Click(object sender, EventArgs e)
        {
            if (CTaiKhoan.CheckQuyen("mnuCapDinhMucNuocCCCD", "Xem"))
            {
                frmCapDinhMucNuocCCCD frm = new frmCapDinhMucNuocCCCD();
                OpenForm(frm);
            }
            else
                MessageBox.Show("Bạn không có quyền Xem Form này", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void mnuCapDinhMucNuocChungCuCCCD_Click(object sender, EventArgs e)
        {
            if (CTaiKhoan.CheckQuyen("mnuCapDinhMucNuocChungCuCCCD", "Xem"))
            {
                frmCapDinhMucNuocChungCu frm = new frmCapDinhMucNuocChungCu();
                OpenForm(frm);
            }
            else
                MessageBox.Show("Bạn không có quyền Xem Form này", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
