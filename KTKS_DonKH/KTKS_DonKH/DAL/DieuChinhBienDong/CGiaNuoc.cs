...
namespace KTKS_DonKH.DAL.DieuChinhBienDong
{
    class CGiaNuoc : CDAL
    {
        ...
        public int TinhTienNuoc(bool DieuChinhGia, int GiaDieuChinh, List<int> lstGiaNuoc, string DanhBo, int Ky, int Nam, int GiaBieu, int DinhMucHN, int DinhMuc, int TieuThu, out string ChiTiet, out int TieuThu_DieuChinhGia)
        {
            try
            {
                string _chiTiet = "";
        ...
        public int TinhTienNuoc(bool DieuChinhGia, int GiaDieuChinh, List<int> lstGiaNuoc, string DanhBo, int Ky, int Nam, int GiaBieu, int DinhMucHN, int DinhMuc, int TieuThu, int TieuThu_GiaDieuChinh2, int GiaTien_GiaDieuChinh2, out string ChiTiet)
        {
            try
            {
                string _chiTiet = "";
        ...
        public void TinhTienNuoc(string DanhBo, int Ky, int Nam, DateTime TuNgay, DateTime DenNgay, int GiaBieu, int DinhMucHN, int DinhMucDC, int TieuThu, out int TienNuocCu, out string ChiTietCu, out int TienNuocMoi, out string ChiTietMoi)
        {
            ...
            if (index != -1)
            {
                if (DenNgay.Date < new DateTime(2019, 11, 15))
                {
                    ...
                    TienNuocCu = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, 0, DinhMucDC, TieuThu, out ChiTietCu, out TieuThu_DieuChinhGia);
                    TienNuocMoi = 0;
                    ChiTietMoi = "";
                }
                else
                    if (TuNgay.Date < lst[index].NgayTangGia.Value.Date && lst[index].NgayTangGia.Value.Date < DenNgay.Date)
                    {
                        ...
                        TienNuocCu = TinhTienNuoc(false, 0, lstGiaNuocCu, DanhBo, Ky, Nam, GiaBieu, 0, DinhMucCu, TieuThuCu, out ChiTietCu, out TieuThu_DieuChinhGia);
                        TienNuocMoi = TinhTienNuoc(false, 0, lstGiaNuocMoi, DanhBo, Ky, Nam, GiaBieu, DinhMucHN_B, DinhMucDC_B, TieuThuMoi, out ChiTietMoi, out TieuThu_DieuChinhGia);
                    }
                    else
                    {
                        int TieuThu_DieuChinhGia;
                        List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                        TienNuocCu = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, DinhMucHN, DinhMucDC, TieuThu, out ChiTietCu, out TieuThu_DieuChinhGia);
                        TienNuocMoi = 0;
                        ChiTietMoi = "";
                    }
            }
        ...
        public int TruyThu(string DanhBo, int Ky, int Nam, int GiaBieu, int DinhMuc, int TieuThu, out string ChiTiet)
        {
            try
            {
                ...
                _TongTien = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, 0, DinhMuc, TieuThu, out _chiTiet, out _tieuthu);
        ...
        public int TruyThu(string DanhBo, int Ky, int Nam, int GiaBieu, int DinhMucHN, int DinhMuc, int TieuThu, out string ChiTiet)
        {
            try
            {
                ...
                _TongTien = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, DinhMucHN, DinhMuc, TieuThu, out _chiTiet, out _tieuthu);
        ...
        public void TinhTienNuoc_Tang_Ky122019(string DanhBo, int DinhMucHN, int DinhMuc, int TieuThu)
        {
            ...
            //if (docso != null)
            {
                ...
                string chitietcu = "";
                int tieuthucu = 0;
                int TienNuocCu = TinhTienNuoc(false, 0, lst2013, "", 12, 2019, 11, 0, dinhmuccu, luongnuoccu, out chitietcu, out tieuthucu);
                string chitietmoi = "";
                int tieuthumoi = 0;
                int TienNuocMoi = TinhTienNuoc(false, 0, lst2019, "", 12, 2019, 11, dinhmucHN, dinhmucDC, luongnuocmoi, out chitietmoi, out tieuthumoi);
