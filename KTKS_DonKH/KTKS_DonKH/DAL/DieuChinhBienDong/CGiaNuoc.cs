...
namespace KTKS_DonKH.DAL.DieuChinhBienDong
{
    class CGiaNuoc : CDAL
    {
        ...
        public int TinhTienNuoc(bool DieuChinhGia, int GiaDieuChinh, List<int> lstGiaNuoc, string DanhBo, int Ky, int Nam, int GiaBieu, int? SH, int? SX, int? DV, int? HCSN, int DinhMucHN, int DinhMuc, int TieuThu, out string ChiTiet, out int TieuThu_DieuChinhGia)
        {
            try
            {
                string _chiTiet = "";
                ...
                switch (GiaBieu)
                {
                    ...
                    case 24:///SH + SX
                        ///Nếu không có tỉ lệ
                        if ((SH == null && SX == null) || (SH.Value == 0 && SX.Value == 0))
                        {
                            //if (TieuThu <= DinhMucHN)
                            //{
                            //    TongTien = TieuThu * lstGiaNuoc[6];
                        ...
                        {
                            //int _SH = 0, _SX = 0;
                            if (SH != null && SH.Value != 0)
                                _SH = (int)Math.Round((double)TieuThu * SH.Value / 100);
                            _SX = TieuThu - _SH;
                            ...
                            if (_SH <= DinhMucHN + DinhMuc)
                            {
                                ...
                                if (!DieuChinhGia)
                                    ...
                                    {
                                        TongTien = (DinhMucHN * lstGiaNuoc[6]) + (DinhMuc * lstGiaNuoc[0]) + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * lstGiaNuoc[1]) + ((_SH - DinhMucHN - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * lstGiaNuoc[2]);
                                        _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[6]) + "\r\n"
                                                    + DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[0]) + "\r\n"
                                                    + (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[1]) + "\r\n"
                    ...
                    case 25:///SH + DV
                        ///Nếu không có tỉ lệ
                        if ((SH == null && DV == null) || (SH.Value == 0 && DV.Value == 0))
                        {
                            //if (TieuThu <= DinhMucHN)
                            //{
                            //    TongTien = TieuThu * lstGiaNuoc[6];
                        ...
                        ///Nếu có tỉ lệ SH + DV
                        {
                            ...
                            if (_SH <= DinhMucHN + DinhMuc)
                            {
                                ...
                                if (!DieuChinhGia)
                                    if (_SH - DinhMuc <= Math.Round((double)(DinhMucHN + DinhMuc) / 2))
                                    {
                                        TongTien = (DinhMucHN * lstGiaNuoc[6]) + (DinhMuc * lstGiaNuoc[0]) + ((_SH - DinhMucHN - DinhMuc) * lstGiaNuoc[1]);
                                        _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[6]) + "\r\n"
                                                    + DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[0]) + "\r\n"
                    ...
                    case 26:///SH + SX + DV
                        ///Nếu chỉ có tỉ lệ SX + DV mà không có tỉ lệ SH, không xét Định Mức
                        if ((SX != null && DV != null && SH == null) || (SX.Value != 0 && DV.Value != 0 && SH.Value == 0))
                        {
                            if (SX != null && SX.Value != 0)
                                _SX = (int)Math.Round((double)TieuThu * SX.Value / 100);
                            _DV = TieuThu - _SX;
                    ...
                    case 38:///SH + HCSN
                        ///Nếu không có tỉ lệ
                        if (SH != null && HCSN != null || (SH.Value == 0 && HCSN.Value == 0))
                        {
                            //if (TieuThu <= DinhMucHN)
                            //{
                            //    TongTien = TieuThu * lstGiaNuoc[6];
                    ...
                    case 39:///SH + HCSN + SX + DV
                        ...
                        if (SH != null && SH.Value != 0)
                            _SH = (int)Math.Round((double)TieuThu * SH.Value / 100);
                        if (HCSN != null && HCSN.Value != 0)
                            _HCSN = (int)Math.Round((double)TieuThu * HCSN.Value / 100);
                        if (SX != null && SX.Value != 0)
                            _SX = (int)Math.Round((double)TieuThu * SX.Value / 100);
                        _DV = TieuThu - _SH - _HCSN - _SX;
                    ...
                    case 34:///HCSN + SX
                        ///Nếu không có tỉ lệ
                        if ((HCSN != null && SX != null) || (HCSN.Value == 0 && SX.Value == 0))
                        {
                            TongTien = TieuThu * lstGiaNuoc[3];
                            _chiTiet = TieuThu + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[3]);
                        }
                    ...
                    case 35:///HCSN + DV
                        ///Nếu không có tỉ lệ
                        if ((HCSN != null && DV != null) || (HCSN.Value == 0 && DV.Value == 0))
                        {
                            TongTien = TieuThu * lstGiaNuoc[5];
                            _chiTiet = TieuThu + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[5]);
                        }
                    ...
                    case 51:///sỉ khu dân cư - Giảm % tiền nước cho ban quản lý chung cư
                        ...
                        if (TieuThu <= DinhMucHN + DinhMuc)
                        {
                            ...
                            if (!DieuChinhGia)
                                ...
                                {
                                    TongTien = (DinhMucHN * (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100)) + (DinhMuc * (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + ((TieuThu - DinhMucHN - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100));
                                    _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100)) + "\r\n"
                                                + DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + "\r\n"
                    ...
                    case 59:///sỉ phức tạp
                        ...
                        if (_SH <= DinhMucHN + DinhMuc)
                        {
                            ...
                            if (!DieuChinhGia)
                                ...
                                {
                                    TongTien = (DinhMucHN * (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100)) + (DinhMuc * (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + ((_SH - DinhMucHN - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100));
                                    _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100)) + "\r\n"
                                                + DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + "\r\n"
                                                + (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + "\r\n"
                                                + (_SH - DinhMucHN - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100));
                                }
                            else
                            {
        ...
        public int TinhTienNuoc2(bool DieuChinhGia, int GiaDieuChinh, List<int> lstGiaNuoc, string DanhBo, int Ky, int Nam, int GiaBieu, int? SH, int? SX, int? DV, int? HCSN, int DinhMucHN, int DinhMuc, int TieuThu, int TieuThu_GiaDieuChinh2, int GiaTien_GiaDieuChinh2, out string ChiTiet)
        {
            try
            {
                string _chiTiet = "";
                ...
                switch (GiaBieu)
                {
                    ...
                    case 10:
                        if (TieuThu <= DinhMucHN)
                        {
                            ...
                            if (!DieuChinhGia)
                                ...
                                {
                                    TongTien = (DinhMucHN * lstGiaNuoc[6])
                                                + ((int)Math.Round((double)(DinhMucHN) / 2) * lstGiaNuoc[1])
                                                + ((TieuThu - DinhMucHN - (int)Math.Round((double)(DinhMucHN) / 2)) * lstGiaNuoc[2])
                                                + TieuThu_GiaDieuChinh2 * GiaTien_GiaDieuChinh2;
                                    _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[6]) + "\r\n"
                                                + (int)Math.Round((double)(DinhMucHN) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[1]) + "\r\n"
                    ...
                    case 29:
                    case 39:///SH + HCSN + SX + DV
                        if ((SH != null && HCSN != null && SX != null && DV != null) || (SH != 0 && HCSN != 0 && SX != 0 && DV != 0))
                        {
                            if (SH != null && SH.Value != 0)
                                _SH = (int)Math.Round((double)TieuThu * SH.Value / 100);
                            if (SH != null && HCSN.Value != 0)
                                _HCSN = (int)Math.Round((double)TieuThu * HCSN.Value / 100);
                            if (SH != null && SX.Value != 0)
                                _SX = (int)Math.Round((double)TieuThu * SX.Value / 100);
                            _DV = TieuThu - _SH - _HCSN - _SX;
                    ...
                    case 45:///SH + DV
                        ...
                        break;
                    case 46:///SH + SX + DV
                        if ((SH != null && SX != null && DV != null) || (SH.Value != 0 && SX.Value != 0 && DV.Value != 0))
                        {
                            if (SH != null && SH.Value != 0)
                                _SH = (int)Math.Round((double)TieuThu * SH.Value / 100);
                            if (SX != null && SX.Value!= 0)
                    ...
                    case 54:///sỉ HCSN
                        ...
                        break;
                    case 58:
                        if ((SH != null && HCSN != null && SX != null && DV != null) || (SH.Value != 0 && HCSN.Value != 0 && SX.Value != 0 && DV.Value != 0))
                        {
                            if (SH != null && SH != 0)
                                _SH = (int)Math.Round((double)TieuThu * SH.Value / 100);
                            if (HCSN != null && HCSN != 0)
                                ...
                                if (!DieuChinhGia)
                                    ...
                                    else
                                    {
                                        TongTien = (DinhMucHN * (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100))
                                                    + (DinhMuc * (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100))
                                                    + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100))
                                                    + ((_SH - DinhMucHN - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100))
                                                    + (TieuThu_GiaDieuChinh2 * (GiaTien_GiaDieuChinh2 - GiaTien_GiaDieuChinh2 * _GiamTienNuoc / 100));
                                        _chiTiet = DinhMucHN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[6] - lstGiaNuoc[6] * _GiamTienNuoc / 100)) + "\r\n"
                                                    + DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + "\r\n"
                                                    + (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + "\r\n"
        ...
        public int TinhTienNuoc_KhuCongNghiep(List<int> lstGiaNuoc, string DanhBo, int GiaBieu, int DinhMucHN, int DinhMucDC, int TieuThu, out string ChiTiet, out float TyLe)
        {
            try
            {
                string _chiTiet = "";
        ...
        //public int TinhTienNuoc(bool DieuChinhGia, int GiaDieuChinh, List<int> lstGiaNuoc, string DanhBo, int Ky, int Nam, int GiaBieu, int DinhMucHN, int DinhMuc, int TieuThu, int SH, int SX, int DV, int HCSN, out string ChiTiet)
        //{
        //    try
        //    {
        //        string _chiTiet = "";
        ...
        //                else
        //                    if (!DieuChinhGia)
        //                        if (TieuThu - DinhMuc <= Math.Round((double)(DinhMucHN + DinhMuc) / 2))
        //                        {
        //                            TongTien = (DinhMuc * lstGiaNuoc[0]) + ((TieuThu - DinhMuc) * lstGiaNuoc[1]);
        ...
        //                        else
        //                        {
        //                            TongTien = (DinhMuc * lstGiaNuoc[0]) + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * lstGiaNuoc[1]) + ((TieuThu - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * lstGiaNuoc[2]);
        //                            _chiTiet = DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[0]) + "\r\n"
        //                                        + (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[1]) + "\r\n"
        //                                        + (TieuThu - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[2]);
        //                        }
        //                    else
        //                    {
        ...
        //                                            + (_SH - DinhMucHN - DinhMuc) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", GiaDieuChinh);
        //                            }
        //                    TongTien += (_HCSN * lstGiaNuoc[4]) + (_DV * lstGiaNuoc[3]) + (_DV * lstGiaNuoc[5]);
        //                    _chiTiet += "\r\n" + _HCSN + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[4]) + "\r\n"
        //                                + _SX + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[3]) + "\r\n"
        //                                + _DV + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", lstGiaNuoc[5]);
        //                }
        ...
        //                        else
        //                        {
        //                            TongTien = (DinhMuc * (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + ((int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) * (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + ((TieuThu - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) * (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100));
        //                            _chiTiet = DinhMuc + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[0] - lstGiaNuoc[0] * _GiamTienNuoc / 100)) + "\r\n"
        //                                        + (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[1] - lstGiaNuoc[1] * _GiamTienNuoc / 100)) + "\r\n"
        //                                        + (TieuThu - DinhMuc - (int)Math.Round((double)(DinhMucHN + DinhMuc) / 2)) + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[2] - lstGiaNuoc[2] * _GiamTienNuoc / 100));
        //                        }
        //                    else
        //                    {
        ...
        public void TinhTienNuoc(bool DieuChinhGia, int GiaDieuChinh, string DanhBo, int Ky, int Nam, DateTime TuNgay, DateTime DenNgay, int GiaBieu, int? SH, int? SX, int? DV, int? HCSN, int DinhMucHN, int DinhMucDC, int TieuThu, out int TienNuocCu, out string ChiTietCu, out int TienNuocMoi, out string ChiTietMoi, out int TieuThu_DieuChinhGia)
        {
            ...
            if (index != -1)
            {
                if (DenNgay.Date < new DateTime(2019, 11, 15))
                {
                    ...
                    TienNuocCu = TinhTienNuoc(DieuChinhGia, GiaDieuChinh, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, 0, DinhMucDC, TieuThu, out ChiTietCu, out TieuThu_DieuChinhGia);
                }
                else
                    if (TuNgay.Date < lst[index].NgayTangGia.Value.Date && lst[index].NgayTangGia.Value.Date < DenNgay.Date)
                    {
                        ...
                        TienNuocCu = TinhTienNuoc(DieuChinhGia, GiaDieuChinh, lstGiaNuocCu, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, 0, DinhMucCu, TieuThuCu, out ChiTietCu, out TieuThu_DieuChinhGia);
                        TienNuocMoi = TinhTienNuoc(DieuChinhGia, GiaDieuChinh, lstGiaNuocMoi, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, DinhMucHN_B, DinhMucDC_B, TieuThuMoi, out ChiTietMoi, out TieuThu_DieuChinhGia);
                    }
                    else
                    {
                        //int TieuThu_DieuChinhGia;
                        List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                        TienNuocCu = TinhTienNuoc(DieuChinhGia, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, DinhMucHN, DinhMucDC, TieuThu, out ChiTietCu, out TieuThu_DieuChinhGia);
                    }
            }
            else
            {
        ...
        public void TinhTienNuoc2(bool DieuChinhGia, int GiaDieuChinh, string DanhBo, int Ky, int Nam, DateTime TuNgay, DateTime DenNgay, int GiaBieu, int? SH, int? SX, int? DV, int? HCSN, int DinhMucHN, int DinhMucDC, int TieuThu, int TieuThu_GiaDieuChinh2, int GiaTien_GiaDieuChinh2, out int TienNuocCu, out string ChiTietCu, out int TienNuocMoi, out string ChiTietMoi)
        {
            ...
            if (index != -1)
            {
                ...
                {
                    List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                    TienNuocCu = TinhTienNuoc2(DieuChinhGia, GiaDieuChinh, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, 0, DinhMucDC, TieuThu, TieuThu_GiaDieuChinh2, GiaTien_GiaDieuChinh2, out ChiTietCu);
                }
                else
                    if (TuNgay.Date < lst[index].NgayTangGia.Value.Date && lst[index].NgayTangGia.Value.Date < DenNgay.Date)
                    {
                        ...
                        List<int> lstGiaNuocCu = new List<int> { lst[index - 1].SHTM.Value, lst[index - 1].SHVM1.Value, lst[index - 1].SHVM2.Value, lst[index - 1].SX.Value, lst[index - 1].HCSN.Value, lst[index - 1].KDDV.Value, lst[index - 1].SHN.Value };
                        List<int> lstGiaNuocMoi = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                        TienNuocCu = TinhTienNuoc2(DieuChinhGia, GiaDieuChinh, lstGiaNuocCu, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, 0, DinhMucCu, TieuThuCu, TieuThu_GiaDieuChinh2, GiaTien_GiaDieuChinh2, out ChiTietCu);
                        TienNuocMoi = TinhTienNuoc2(DieuChinhGia, GiaDieuChinh, lstGiaNuocMoi, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, DinhMucHN_B, DinhMucDC_B, TieuThuMoi, TieuThu_GiaDieuChinh2, GiaTien_GiaDieuChinh2, out ChiTietMoi);
                    }
                    else
                    {
                        List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                        TienNuocCu = TinhTienNuoc2(DieuChinhGia, GiaDieuChinh, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, DinhMucHN, DinhMucDC, TieuThu, TieuThu_GiaDieuChinh2, GiaTien_GiaDieuChinh2, out ChiTietCu);
                    }
            }
            else
            {
        ...
        public void TinhTienNuoc_KhuCongNghiep(string DanhBo, int Ky, int Nam, DateTime TuNgay, DateTime DenNgay, int GiaBieu, int DinhMucHN, int DinhMucDC, int TieuThu, out int TienNuocCu, out string ChiTietCu, out int TienNuocMoi, out string ChiTietMoi, out float TyLe)
        {
            ...
            if (index != -1)
            {
                ...
                {
                    List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                    TienNuocCu = TinhTienNuoc_KhuCongNghiep(lstGiaNuoc, DanhBo, GiaBieu, DinhMucHN, DinhMucDC, TieuThu, out ChiTietCu, out TyLe);
                }
                else
                    if (TuNgay.Date < lst[index].NgayTangGia.Value.Date && lst[index].NgayTangGia.Value.Date < DenNgay.Date)
                    {
                        ...
                        List<int> lstGiaNuocCu = new List<int> { lst[index - 1].SHTM.Value, lst[index - 1].SHVM1.Value, lst[index - 1].SHVM2.Value, lst[index - 1].SX.Value, lst[index - 1].HCSN.Value, lst[index - 1].KDDV.Value, lst[index - 1].SHN.Value };
                        List<int> lstGiaNuocMoi = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
                        TienNuocCu = TinhTienNuoc_KhuCongNghiep(lstGiaNuocCu, DanhBo, GiaBieu, 0, DinhMucCu, TieuThuCu, out ChiTietCu, out TyLe);
                        TienNuocMoi = TinhTienNuoc_KhuCongNghiep(lstGiaNuocMoi, DanhBo, GiaBieu, DinhMucHN_B, DinhMucDC_B, TieuThuMoi, out ChiTietMoi, out TyLe);
                    }
                    else
                    {
                        List<int> lstGiaNuoc = new List<int> { lst[index].SHTM.Value, lst[index].SHVM1.Value, lst[index].SHVM2.Value, lst[index].SX.Value, lst[index].HCSN.Value, lst[index].KDDV.Value, lst[index].SHN.Value };
        ...
        public int TruyThu(string DanhBo, int Ky, int Nam, int GiaBieu, int SH, int SX, int DV, int HCSN, int DinhMuc, int TieuThu, out string ChiTiet)
        {
            try
            {
                ...
                _TongTien = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, 0, DinhMuc, TieuThu, out _chiTiet, out _tieuthu);
        ...
        public int TruyThu(string DanhBo, int Ky, int Nam, int GiaBieu, int SH, int SX, int DV, int HCSN, int DinhMucHN, int DinhMuc, int TieuThu, out string ChiTiet)
        {
            try
            {
                ...
                _TongTien = TinhTienNuoc(false, 0, lstGiaNuoc, DanhBo, Ky, Nam, GiaBieu, SH, SX, DV, HCSN, DinhMucHN, DinhMuc, TieuThu, out _chiTiet, out _tieuthu);
