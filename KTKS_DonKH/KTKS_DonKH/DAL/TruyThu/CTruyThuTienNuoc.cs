        ...
        public DataTable getDS(int IDCT)
        {
            var query = from item in db.TruyThuTienNuoc_ChiTiets
                        ...
                        select new
                        {
                            ...
                            //item.TongTien,
                            //item.Tongm3BinhQuan,
                            TongTien = item.TruyThuTienNuoc_HoaDons.Count > 0 ? item.TruyThuTienNuoc_HoaDons.Sum(itemCT => (long)itemCT.TongCongMoi) - item.TruyThuTienNuoc_HoaDons.Sum(itemCT => (long)itemCT.TongCongCu) : 0,
                            Tongm3BinhQuan = item.TruyThuTienNuoc_HoaDons.Count > 0 ? Math.Round((item.TruyThuTienNuoc_HoaDons.Sum(itemCT => (long)itemCT.TongCongMoi) - item.TruyThuTienNuoc_HoaDons.Sum(itemCT => (long)itemCT.TongCongCu)) / (item.SoTien1m3 * 1.15), MidpointRounding.AwayFromZero) : 0,
