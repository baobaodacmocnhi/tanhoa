                ...
                case "TKH":
                    var query = from itemChuyenKTXM in db.LichSuDonTus
                                ...
                                select new
                                {
                                    ...
                                    GiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao==true||item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                    ? true : db.BamChi_ChiTiets.Any(item => item.BamChi.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date),
                                    NgayGiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                    ? db.KTXM_ChiTiets.FirstOrDefault(item => item.KTXM.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)).NgayKTXM : 
                                    db.BamChi_ChiTiets.Any(item => item.BamChi.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date) == true
                                    ? db.BamChi_ChiTiets.FirstOrDefault(item => item.BamChi.MaDon == itemDonTKH.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date).NgayBC : null,
                                };
                    dt = LINQToDataTable(query.ToList());
                    break;
                case "TXL":
                    query = from itemChuyenKTXM in db.LichSuDonTus
                            ...
                            select new
                            {
                                ...
                                NguoiDi = itemUser.HoTen,
                                itemChuyenKTXM.GhiChu,
                                GiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                ? true : db.BamChi_ChiTiets.Any(item => item.BamChi.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date),
                                NgayGiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                ? db.KTXM_ChiTiets.FirstOrDefault(item => item.KTXM.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)).NgayKTXM : 
                                db.BamChi_ChiTiets.Any(item => item.BamChi.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date) == true
                                ? db.BamChi_ChiTiets.FirstOrDefault(item => item.BamChi.MaDonTXL == itemDonTXL.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date).NgayBC : null,
                            };
                    dt = LINQToDataTable(query.ToList());
                    break;
                case "TBC":
                    query = from itemChuyenKTXM in db.LichSuDonTus
                            ...
                            select new
                            {
                                ...
                                NguoiDi = itemUser.HoTen,
                                itemChuyenKTXM.GhiChu,
                                GiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                ? true : db.BamChi_ChiTiets.Any(item => item.BamChi.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date),
                                NgayGiaiQuyet = db.KTXM_ChiTiets.Any(item => item.KTXM.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)) == true
                                ? db.KTXM_ChiTiets.FirstOrDefault(item => item.KTXM.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && (item.NgayKTXM_Truoc_NgayGiao == true || item.NgayKTXM.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date)).NgayKTXM : 
                                db.BamChi_ChiTiets.Any(item => item.BamChi.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date) == true
                                ? db.BamChi_ChiTiets.FirstOrDefault(item => item.BamChi.MaDonTBC == itemDonTBC.MaDon && item.CreateBy == itemChuyenKTXM.ID_NoiNhan && item.NgayBC.Value.Date >= itemChuyenKTXM.NgayChuyen.Value.Date).NgayBC : null,
                            };
                    dt = LINQToDataTable(query.ToList());
                    break;
            }
