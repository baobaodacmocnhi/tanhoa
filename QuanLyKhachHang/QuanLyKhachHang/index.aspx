<%@ Page Title="" Language="C#" MasterPageFile="~/mHome.Master" AutoEventWireup="true"
    CodeBehind="index.aspx.cs" Inherits="QuanLyKhachHang.index1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text">
        <table>
            <tr>
                <td style="width: 80px;">
                    <asp:DropDownList ID="dot" runat="server" Height="19px" Width="85px">
                ...
                <td>
                    <asp:TextBox ID="txtDB" runat="server" OnTextChanged="txtDB_TextChanged" Style="margin-left: 0px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Panel ID="Panel3" runat="server" ScrollBars="Both" Width="331px" Height="100px"
                        ...
                        <asp:Panel ID="Panel4" runat="server" Width="800px" Height="100%">
                            <asp:GridView ID="GridView3" runat="server" Width="100%" AutoGenerateColumns="False"
                                CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="GridView3_RowCommand">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:TemplateField HeaderText="DANH BO" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="DB" runat="server" CausesValidation="False" CommandArgument='<%# Bind("DANHBO") %>'
                                                CommandName="Select" Text='<%# Bind("DANHBO") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="HOTEN" HeaderText="HOTEN"></asp:BoundField>
        ...
        <table>
            <tr>
                <td class="style1" colspan="2">
                    Khách Hàng:&nbsp;<asp:Label ID="lbTenKh" runat="server" Font-Bold="True" />
                    <asp:Label ID="lbDanhBo" runat="server" Font-Bold="True" Visible="False" />
                </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    Địa Chỉ:&nbsp;<asp:Label ID="diachi" runat="server" Font-Bold="True" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SĐT:&nbsp;<asp:Label
                        ID="sdt" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
                    Hợp Đồng :
                    <asp:Label ID="hopdong" runat="server" Font-Bold="True" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Lộ Trình:&nbsp;<asp:Label
                        ID="lotrinh" runat="server" Font-Bold="True" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
                    Hiệu Lực :
                    <asp:Label ID="hieuluc" runat="server" Font-Bold="True" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; GB:&nbsp;<asp:Label ID="giabieu" runat="server" Font-Bold="True" />
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; ĐM :
                    <asp:Label ID="dinhmuc" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
                    Ngày Gắn:&nbsp;<asp:Label ID="ngaygan" runat="server" Font-Bold="True" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ngày KĐ:
                    <asp:Label ID="ngaykiemdinh" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    Hiệu ĐHN:&nbsp;<asp:Label ID="hieudhn" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    NV Đọc Số :&nbsp;<asp:Label ID="nvds" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    NV Thu Tiền :&nbsp;<asp:Label ID="nvtt" runat="server" Font-Bold="True" />
                </td>
            </tr>
            <tr>
                <td class="title_mobile" style="border-bottom: 1px  #FF0000 solid; background-color: #FFFF99;
                ...
                <td class="style1" colspan="2">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Width="100%" Height="150px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Names="Times New Roman"
                ...
                <td class="style1" colspan="2">
                    <asp:Panel ID="Panel2" runat="server" ScrollBars="Both" Width="100%" Height="150px">
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            Font-Names="Times New Roman" Font-Size="12px" GridLines="None" Width="100%" ForeColor="#333333">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
            ...
            <tr>
                <td colspan="2">
                    <asp:Panel ID="Panel5" runat="server" ScrollBars="Both" Width="100%" Height="150px">
        ...
        function initAutocomplete() {
         <% 
                    ...
                    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBnK4XMpV0do1pWTYFGUydQvA_EyMkJ9xU&libraries=places&callback=initAutocomplete"
                        async defer></script>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style4">
                    <asp:Button ID="btUploag" runat="server" Text="Upload" OnClick="btUploag_Click" />
                    <asp:Label ID="upload" runat="server" ForeColor="Red" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <marquee behavior='scroll' scrollamount='20' direction='left' onmouseover='this.stop();'
                        onmouseout='this.start();'>  <asp:Panel ID="PanelImg" runat="server"></asp:Panel></marquee>
                </td>
            </tr>
            <tr>
                <td colspan="2">
